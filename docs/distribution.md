...
This repository is the canonical source for all hosts. Release `v0.2.0` contains
...
`https://raw.githubusercontent.com/terraphim/terraphim-cursor-plugin/v0.2.0/marketplaces/kimi.json`
and install
...
Download the three ZIP files and `SHA256SUMS` from the `v0.2.0` release. Verify
...
`https://raw.githubusercontent.com/terraphim/terraphim-cursor-plugin/v0.2.0/marketplaces/zcode.json`
...
Record the immutable `v0.2.0` provenance. Remove the skills with Hermes' normal
...
skills are offered and that their files match tag `v0.2.0`. Update by repeating the
